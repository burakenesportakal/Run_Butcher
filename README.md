<h1 align="center">🏃‍♂️ Run Butcher RUN!</h1>
<h3 align="center">An Endless Runner Adventure Inspired by a Fleeing King</h3>
...
<ul>
  <li><strong>Controls:</strong> WASD to move, ESC for the pause menu.</li>
  <li><strong>Collectibles:</strong> Collect coins 💰 for points and apples 🍎 for extra points and speed boosts ⚡.</li>
  <li><strong>Hazards:</strong> Avoid obstacles 🪨—big rocks shake bridges and trigger fun particles and sound effects ✨.</li>
  <li><strong>Progression:</strong> Checkpoints ⏱️ give extra time, increasing the challenge with every run.</li>
</ul>

<h2>🎨 Aesthetic</h2>
<ul>
  <li>✨ Low-poly 3D visuals</li>
  <li>✨ Lighthearted, fun atmosphere</li>
  <li>✨ Exciting music that intensifies as you run</li>
</ul>

<h2>🧩 Ideal for</h2>
<ul>
  <li>💡 Fans of endless runners</li>
  <li>💡 Players who enjoy collecting, dodging, and mastering movement</li>
  <li>💡 Anyone looking for a quick, thrilling game session</li>
</ul>
